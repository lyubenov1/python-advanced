...
def mark_word_letters(vowel, consonant, word_dict):
    result = False
...
while vowels and consonants:
    ...
    if mark_word_letters(vowel, consonant, rose):
        if all(rose.values()):
            found_flower = 'rose'
            break

    if mark_word_letters(vowel, consonant, tulip):
        if all(tulip.values()):
            found_flower = 'tulip'
            break

    if mark_word_letters(vowel, consonant, lotus):
        if all(lotus.values()):
            found_flower = 'lotus'
            break

    if mark_word_letters(vowel, consonant, daffodil):
